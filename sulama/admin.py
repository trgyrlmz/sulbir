...
class UrunAdmin(admin.ModelAdmin):
    list_display = ['isim', 'sulama', 'baslangic_tarihi', 'bitis_tarihi', 'kar_orani', 'olusturma_tarihi']
    list_filter = ['sulama__bolge', 'baslangic_tarihi', 'bitis_tarihi', 'olusturma_tarihi']
    search_fields = ['isim', 'sulama__isim', 'sulama__bolge__isim']
    readonly_fields = ['olusturma_tarihi']
